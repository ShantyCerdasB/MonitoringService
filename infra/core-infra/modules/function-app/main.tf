# Azure Functions API backend for the monitoring service
# Provides serverless compute for API endpoints and background processing

# Current Azure AD tenant configuration
data "azuread_client_config" "current" {}

# API application service principal
...
resource "azurerm_function_app" "function_app" {
  ...
  app_settings = {
    ...
    # Azure AD group IDs for role-based access
