# Azure Static Web App for hosting the admin interface
# Provides serverless hosting for React/Vue/Angular applications
...
# Data source to retrieve Static Web App properties
